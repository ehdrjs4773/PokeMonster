...
void inventory::UtilMenuDraw() //인벤토리 유틸 Menu 그려주는 함수
{
	...
	if (_selectItem[INDEXS_BUTTON_0].Selected) //1번째 아이템 
	{
		if (_invenSlot_UTIL[0].number > 0)
		{
			...
			tempItem->setItemInfo(_invenSlot_UTIL[0].itm);
	...
	if (_selectItem[INDEXS_BUTTON_1].Selected) //2번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_UTIL[1].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_2].Selected) //3번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_UTIL[2].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
			_invenSlot_UTIL[2].itm->setItemNum(_invenSlot_UTIL[2].itm->getItemNum() - 1);
			if (_invenSlot_UTIL[2].itm->getItemNum() == 0)  deleteItem(_invenSlot_UTIL[2].key);
		}
	...
	if (_selectItem[INDEXS_BUTTON_3].Selected) //4번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_UTIL[3].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
			_invenSlot_UTIL[3].itm->setItemNum(_invenSlot_UTIL[3].itm->getItemNum() - 1);
			if (_invenSlot_UTIL[3].itm->getItemNum() == 0)  deleteItem(_invenSlot_UTIL[3].key);
		}
	...
	if (_selectItem[INDEXS_BUTTON_4].Selected) //5번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_UTIL[4].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
			_invenSlot_UTIL[4].itm->setItemNum(_invenSlot_UTIL[4].itm->getItemNum() - 1);
			if (_invenSlot_UTIL[4].itm->getItemNum() == 0)  deleteItem(_invenSlot_UTIL[4].key);
		}
	...
	if (_selectItem[INDEXS_BUTTON_5].Selected) //6번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_UTIL[5].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_0].Selected) //1번째 아이템 
	{
		if (_invenSlot_BALL[0].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_invenSlot_BALL[0].itm->setItemNum(_invenSlot_BALL[0].itm->getItemNum() - 1);
				if (_invenSlot_BALL[0].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[0].key);
			}
		}
		_selectItem[INDEXS_BUTTON_0].Selected = false;
	}
	if (_selectItem[INDEXS_BUTTON_1].Selected) //2번째 아이템 
	{
		if (_invenSlot_BALL[1].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_battleScene->setSequenceCatch();
				SCENEMANAGER->changeScene("battleScene");
				_invenSlot_BALL[1].itm->setItemNum(_invenSlot_BALL[1].itm->getItemNum() - 1);
				if (_invenSlot_BALL[1].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[1].key);
			}
		}
		_selectItem[INDEXS_BUTTON_1].Selected = false;
	}
	if (_selectItem[INDEXS_BUTTON_2].Selected) //3번째 아이템 
	{
		if (_invenSlot_BALL[2].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_battleScene->setSequenceCatch();
				SCENEMANAGER->changeScene("battleScene");
				_invenSlot_BALL[2].itm->setItemNum(_invenSlot_BALL[2].itm->getItemNum() - 1);
				if (_invenSlot_BALL[2].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[2].key);
			}
		}
		_selectItem[INDEXS_BUTTON_2].Selected = false;
	}
	if (_selectItem[INDEXS_BUTTON_3].Selected) //4번째 아이템 
	{
		if (_invenSlot_BALL[3].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_battleScene->setSequenceCatch();
				SCENEMANAGER->changeScene("battleScene");
				_invenSlot_BALL[3].itm->setItemNum(_invenSlot_BALL[3].itm->getItemNum() - 1);
				if (_invenSlot_BALL[3].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[3].key);
			}
		}
		_selectItem[INDEXS_BUTTON_3].Selected = false;
	}
	if (_selectItem[INDEXS_BUTTON_4].Selected) //5번째 아이템 
	{
		if (_invenSlot_BALL[4].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_battleScene->setSequenceCatch();
				SCENEMANAGER->changeScene("battleScene");
				_invenSlot_BALL[4].itm->setItemNum(_invenSlot_BALL[4].itm->getItemNum() - 1);
				if (_invenSlot_BALL[4].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[4].key);
			}
		}
		_selectItem[INDEXS_BUTTON_4].Selected = false;
	}
	if (_selectItem[INDEXS_BUTTON_5].Selected) //6번째 아이템 
	{
		if (_invenSlot_BALL[5].slotUse == true)
		{
			if (_battleScene->getCurrentEnemyType() == ENEMY_WILD)
			{
				...
				_battleScene->setSequenceCatch();
				SCENEMANAGER->changeScene("battleScene");
				_invenSlot_BALL[5].itm->setItemNum(_invenSlot_BALL[5].itm->getItemNum() - 1);
				if (_invenSlot_BALL[5].itm->getItemNum() == 0)  deleteItem(_invenSlot_BALL[5].key);
			}
		}
		_selectItem[INDEXS_BUTTON_5].Selected = false;
	}
...
void inventory::MachineMenuDraw() //인벤토리 머신 Menu 그려주는 함수
{
	...
	if (_selectItem[INDEXS_BUTTON_0].Selected) //1번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[0].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_1].Selected) //2번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[1].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_2].Selected) //3번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[2].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_3].Selected) //4번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[3].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_4].Selected) //5번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[4].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
	...
	if (_selectItem[INDEXS_BUTTON_5].Selected) //6번째 아이템 
	{
		...
		{
			item* tempItem = new item;
			tempItem->setItemInfo(_invenSlot_MACHINE[5].itm);
			_currentItem = tempItem;
			SCENEMANAGER->changeScene("PokeInfo");
			SCENEMANAGER->init("PokeInfo");
			_battleScene->getBattleSceneUI()->selectReset();
			_invenSlot_MACHINE[5].itm->setItemNum(_invenSlot_MACHINE[5].itm->getItemNum() - 1);
